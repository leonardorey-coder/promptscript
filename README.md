...
Principios de diseño
	1.	El DSL controla el flujo
	2.	El LLM no controla la ejecución
	3.	Toda salida es validada
	4.	Toda acción es auditada
	5.	Toda ejecución es reproducible
...
Contribuir
	1.	Lee los RFCs
	2.	Abre un issue antes de cambios grandes
	3.	Usa el proceso de RFC para breaking changes
	4.	PRs pequeños y auditables
